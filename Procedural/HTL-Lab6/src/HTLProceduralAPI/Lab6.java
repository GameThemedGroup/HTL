 ...
 * 
 * ----------------------------------------------------------------------------
 * LAB 6 - Nested If: Moving Wizards
 * 
 * LEARNING OBJECTIVE:
 * 		Student will be able to demonstrate an understanding of customizing
 * 		graphic by replacing files in the resource folder and also concepts
